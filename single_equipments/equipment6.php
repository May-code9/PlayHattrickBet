          ...
          <div class="layout-horizontal layout-horizontal_1">
            <div class="layout-horizontal__aside">
              <div class="reveal-flex">
                <!-- Thumb Zoe-->
                <a class="">
                  <img class="thumb-zoe__image" src="../images/equipment6.png" alt="" width="226" height="284"/>
                </a>
              </div>
            </div>
            <div class="layout-horizontal__main">
              <article class="single-product">
                <div class="single-product__header">
                  <h3 class="single-product__title">Cat Excavator</h3>
                  ...
                  <div class="tabs-custom tabs-horizontal tabs-line">
                    ...
                    <div class="tab-content">
                      <div class="tab-pane fade in active" id="tabs-product-1">
                        <p>
                          <span class="just">Model: </span><br>CAT 245, 325C LN, 320L, 330L, 325CL, 330C <br>
                          WILCO 3200D AMPHIBIOUS, EXCAVATOR (SWAMP BUGGY), HYUNDAI ROBEX 200W, HYUNDAI ROBEX 140 LC -7<br>
                          <span class="just">Number Owned: </span><br>12 <br>
                          <span class="just">Capacity: </span><br>MAX BUCKET CAP: 2.9m3, 2.3m3, 1.3m3, 2.1m3, 2.3m3, 2.9m3, 0.71m3<br>
                          REACH BOOM: 35ft, BUCKET: 1040ltr<br>
                          <span class="just">Specification: </span><br>HYDRAULIC EXCAVATOR, SWAMP BUGGY, WHEEL - TYRE, WHEEL - TRACK <br>
                        </p>
                      </div>
