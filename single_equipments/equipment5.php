          ...
          <div class="layout-horizontal layout-horizontal_1">
            <div class="layout-horizontal__aside">
              <div class="reveal-flex">
                <!-- Thumb Zoe-->
                <a class="">
                  <img class="thumb-zoe__image" src="../images/equipment5.png" alt="" width="226" height="284"/>
                </a>
              </div>
            </div>
            <div class="layout-horizontal__main">
              <article class="single-product">
                <div class="single-product__header">
                  <h3 class="single-product__title">Truck</h3>
                  ...
                  <div class="tabs-custom tabs-horizontal tabs-line">
                    ...
                    <div class="tab-content">
                      <div class="tab-pane fade in active" id="tabs-product-1">
                        <p>
                          <span class="just">Model: </span><br>AUTOCAR, MAN DIESEL 26.292, MAN DIESEL 19.281, MAN 25.372 <br>
                          <span class="just">Number Owned: </span><br>13 <br>
                          <span class="just">Specification: </span><br>TRUCK HEAD, SELF LOADING TRUCK <br>
                        </p>
                      </div>
