  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="breadcrumbs-custom bg-image" style="background-image: url(images/bg-image-1.jpg);">
        <div class="shell">
          <h2 class="breadcrumbs-custom__title">Grid system</h2>
        ...
        <div class="shell">
          <div class="range range-50 range-sm-center">
            <div class="cell-sm-9 cell-md-8 cell-lg-6">
              <h3>Grid system</h3>
              <p class="big">A responsive fluid grid system that appropriately scales up to 12 columns with gourgeous full-width and boxed options.</p>
            </div>
          </div>
        </div>
      </section>
