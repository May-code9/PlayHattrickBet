  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="breadcrumbs-custom bg-image" style="background-image: url(images/bg-image-5.jpg);">
        <div class="shell">
          <h2 class="breadcrumbs-custom__title">Sitemap</h2>
      ...
      <section class="section section-lg bg-white">
        <div class="shell">
          <div class="range range-xs-center range-50">
            <div class="cell-xs-6 cell-sm-5 cell-md-4 cell-lg-3">
              <p class="list-linked-header"><a href="index.php">Home</a></p>
              <p class="list-linked-header"><a href="about-us.php">About Us</a></p>
              <ul class="list-linked">
                <li><a href="top-management.php">Top management</a></li>
                <li><a href="testimonials.php">Testimonials</a></li>
              </ul>
              <p class="list-linked-header"><a href="production.php">Production</a></p>
              <p class="list-linked-header"><a href="products.php">Products</a></p>
              <ul class="list-linked">
                <li><a href="single-product.php">Single product</a></li>
              </ul>
              <p class="list-linked-header"><a href="news.php">News</a></p>
              <ul class="list-linked">
                <li><a href="single-post.php">Single post</a></li>
              </ul>
              <p class="list-linked-header"><a href="contacts.php">Contacts</a></p>
              <p class="list-linked-header">Pages 1</p>
              <ul class="list-linked">
                <li><a href="careers.php">Careers</a></li>
                <li><a href="top-management.php">Top management</a></li>
                <li><a href="invest.php">Invest</a></li>
            ...
            <div class="cell-xs-6 cell-sm-5 cell-md-4 cell-lg-3">
              <p class="list-linked-header">Pages 2</p>
              <ul class="list-linked">
                <li><a href="404-page.php">404 page</a></li>
                <li><a href="coming-soon.php">Coming soon</a></li>
                <li><a href="maintenance.php">Maintenance</a></li>
              ...
              <p class="list-linked-header">Elements </p>
              <ul class="list-linked">
                <li><a href="buttons.php">Buttons</a></li>
                <li><a href="forms.php">Forms</a></li>
                <li><a href="grid-system.php">Grid system</a></li>
              ...
              <p class="list-linked-header">Layouts</p>
              <ul class="list-linked">
                <li><a href="header-default.php">Header Default</a></li>
                <li><a href="header-fullwidth.php">Header Fullwidth</a></li>
                <li><a href="header-sidebar.php">Header Sidebar</a></li>
