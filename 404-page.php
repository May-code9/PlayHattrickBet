...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="breadcrumbs-custom bg-image" style="background-image: url(images/bg-image-10.jpg);">
        <div class="shell">
      ...
      <section class="section section-sm bg-white text-center">
        <div class="shell">
          <div class="range range-sm-center">
            <div class="cell-lg-7">
              <h2>Sorry, but the page <br class="veil reveal-md-block"> was not found</h2>
              <p class="large">You may have mistyped the address or the page may have moved.</p>
              <div class="group-sm group-sm_mod-1"> <a class="button button-darker" href="index.php">Go to home page</a>
                <p class="text-bold">or</p><a class="button button-primary" href="contacts.php">Contact us</a>
              </div>
            </div>
          </div>
        </div>
