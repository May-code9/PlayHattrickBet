...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    ...
    <div class="page">
      ...
      <!-- Breadcrumbs-->
      <section class="breadcrumbs-custom bg-image" style="background-image: url(images/bg-image-7.jpg);">
        <div class="shell">
          <h2 class="breadcrumbs-custom__title">Top management</h2>
          <ul class="breadcrumbs-custom__path">
            <li><a href="index.php">Home</a></li>
            <li><a href="about-us.php">About Us</a></li>
            <li class="active">Top management</li>
          </ul>
        </div>
      </section>
        ...
        <div class="shell">
          <div class="range range-30">
            <div class="cell-sm-6 cell-md-4">
              ...
              <article class="card-creative">
                ...
                <div class="card-creative__main" data-fixed-height="">
                  ...
                  <p class="card-creative__subtitle">CEO “Creator”</p>
            ...
            <div class="cell-sm-6 cell-md-4">
              <!-- Card creative-->
              <article class="card-creative">
                <div class="card-creative__header"><img src="images/top-management-4-115x119.jpg" alt="" width="115" height="119"/>
                </div>
                <div class="card-creative__main" data-fixed-height="">
                  <p class="card-creative__title">Mary Johnson</p>
                  <p class="card-creative__subtitle">Office Manager</p>
                  <div class="card-creative__element"><a href="mailto:#">info@demolink.org</a></div>
                </div>
              </article>
            </div>
            <div class="cell-sm-6 cell-md-4">
              <!-- Card creative-->
              <article class="card-creative">
                <div class="card-creative__header"><img src="images/top-management-5-115x119.jpg" alt="" width="115" height="119"/>
                </div>
                <div class="card-creative__main" data-fixed-height="">
                  <p class="card-creative__title">John Smith </p>
                  <p class="card-creative__subtitle">Wholesale Manager</p>
                  <div class="card-creative__element"><a href="mailto:#">info@demolink.org</a></div>
                </div>
              </article>
            </div>
            <div class="cell-sm-6 cell-md-4">
              <!-- Card creative-->
              <article class="card-creative">
                <div class="card-creative__header"><img src="images/top-management-6-115x119.jpg" alt="" width="115" height="119"/>
                </div>
                <div class="card-creative__main" data-fixed-height="">
                  <p class="card-creative__title">Jane Moore</p>
