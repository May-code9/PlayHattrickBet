...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    ...
    <div class="page">
      ...
      <!-- Breadcrumbs-->
      <section class="breadcrumbs-custom bg-image" style="background-image: url(images/bg-image-12.jpg);">
        <div class="shell">
          ...
          <div class="range range-md-center">
            <div class="cell-md-10 cell-lg-8">
              ...
              <div class="countdown-wrap">
                <div class="DateCountdown" data-type="until" data-date="2017-12-31 00:00:00" data-format="wdhms" data-color="#f5a63f" data-bg="rgba(245, 245, 245, 1)" data-width="0.02"></div>
              </div>
            </div>
          </div>
        </div>
