    ...
    <div class="page">
      <header class="page-header section">
        ...
        <div class="rd-navbar-wrap">
          <nav class="rd-navbar" data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed" data-sm-device-layout="rd-navbar-fixed" data-md-layout="rd-navbar-sidebar" data-md-device-layout="rd-navbar-fixed" data-lg-device-layout="rd-navbar-sidebar" data-lg-layout="rd-navbar-sidebar" data-stick-up-clone="false" data-md-stick-up-offset="1px" data-lg-stick-up-offset="1px" data-md-stick-up="true" data-lg-stick-up="true" data-lg-hover-on="false">
            <div class="rd-navbar-main-outer">
              <div class="rd-navbar-main">
                <!-- RD Navbar Content-->
                <div class="rd-navbar-content-outer">
                  <div class="rd-navbar-content__toggle rd-navbar-sidebar--hidden" data-rd-navbar-toggle=".rd-navbar-content"><span></span></div>
                ...
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-main-item"><a class="button button-xs button-lighter" href="contacts.php">Get a quote</a></div>
      ...
      <section class="breadcrumbs-custom bg-image" style="background-image: url(images/bg-image-7.jpg);">
        <div class="shell">
          <h2 class="breadcrumbs-custom__title">Header Sidebar</h2>
          <ul class="breadcrumbs-custom__path">
            <li><a href="index.php">Home</a></li>
            <li><a href="#">Pages</a></li>
            <li class="active">Header Sidebar</li>
          </ul>
        </div>
      </section>
        ...
        <div class="shell">
          <div class="range range-70 range-sm-center range-lg-justify">
            <div class="cell-sm-10 cell-md-6 cell-lg-5">
              ...
              <p>Creator is the leading provider of specialty services to North America's process industries.</p>
