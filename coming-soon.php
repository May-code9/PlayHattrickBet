...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    ...
    <div class="page">
      <!-- Page content-->
      <div class="section section-single bg-gray-dark bg-image" style="background-image: url(images/bg-image-11.jpg);">
          ...
          <div class="section-single__main">
            <div class="shell">
              ...
              <div class="countdown-wrap">
                <div class="DateCountdown" data-type="until" data-date="2018-12-31 00:00:00" data-format="wdhms" data-color="#f5a63f" data-bg="rgba(255, 255, 255, 1)" data-width="0.02"></div>
              </div>
              <p style="max-width: 450px;">Our website is under construction, we are working very hard to give you the best experience on our new web site.</p>
